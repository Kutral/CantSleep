...
export default function PrivacyPolicy() {
  return (
    <div className="pt-32 pb-20 px-6 relative z-10 max-w-4xl mx-auto min-h-screen">
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="glass-panel p-8 md:p-12 rounded-3xl"
      >
        <h1 className="text-4xl md:text-5xl font-display font-bold mb-6">Privacy Policy for Can't Sleep</h1>
        <p className="text-slate-400 mb-10 pb-10 border-b border-white/5">
          <strong>Effective Date:</strong> April 22, 2026
        </p>

        <div className="text-slate-300 space-y-8 leading-relaxed">
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">Plain Language Summary</h2>
            <p>
          ...
          <section>
            ...
            <p className="mb-4">When you use Can't Sleep, we or our third-party service providers may collect the following types of information:</p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">4. Advertising and Advertising ID</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">5. Purchases and Subscriptions</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">6. Local Storage and Journal Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">7. Permissions</h2>
            <p className="mb-4">Can't Sleep may request certain Android permissions to function properly. We only request permissions necessary for the app's core features:</p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">8. Third-Party Services</h2>
            <p className="mb-4">We use the following third-party services which may collect, process, or store data as described in their respective privacy policies:</p>
            <ul className="list-disc pl-6 space-y-2 text-slate-400">
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">9. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">10. Your Choices</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">12. Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">13. International Users</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-display font-semibold text-white mb-4">14. Changes to This Policy</h2>
            <p>
          ...
          <section className="pt-6 border-t border-white/5">
            ...
            <p className="mb-4">If you have any questions or suggestions about our Privacy Policy, please contact us:</p>
